...
Jugador (P): personaje controlado por el usuario
Enemigo perseguidor (E): se mueve en dirección al jugador
Enemigo patrulla (M): se desplaza de manera horizontal automática
Llave (K): objeto necesario para ganar
Puerta (D): salida del mapa
...
game.cpp / game.h: lógica principal del juego
player.cpp / player.h: manejo del jugador
enemy.cpp / enemy.h: comportamiento de enemigos
map.cpp / map.h: creación y dibujo del mapa
...
Diseñar un programa modular en C++
Implementar lógica básica de videojuegos
Manejar múltiples archivos y responsabilidades
